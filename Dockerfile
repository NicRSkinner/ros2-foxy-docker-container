...
RUN apt install -y ros-foxy-cv-bridge ros-foxy-librealsense2 ros-foxy-message-filters ros-foxy-image-transport
...
#RUN apt install ros-foxy-realsense-camera-msgs ros-foxy-realsense-ros2-camera
